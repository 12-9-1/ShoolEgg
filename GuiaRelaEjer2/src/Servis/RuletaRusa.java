...
public class RuletaRusa {
    ...
    public Juego llenarJuego(ArrayList<Jugador> jugadores, RevolverDeAgua r1) {
        ...
        System.out.println("Hola has entrado al juego de la ruleta rusa de agua");
    ...
    public void ronda() {
        ...
        for (Jugador jugador : juego.getJugadores()) {
            ...
            if (disparo == true) {
                ...
                System.out.println("Has perdido jugador " + jugador.getNombre() + " está mojado");
